...
umap2_col_default = "UMAP_2"
anno1_col_default = "seurat_clusters"
...
meta <- getShinyOption("meta", meta_default)
umap1_col <- getShinyOption("umap1_col", umap1_col_default)
umap2_col <- getShinyOption("umap2_col", umap2_col_default)
anno1_col <- getShinyOption("anno1_col", anno1_col_default)
anno2_col <- getShinyOption("anno2_col", anno2_col_default)
anno3_col <- getShinyOption("anno3_col", anno3_col_default)
species_detected <- getShinyOption("species_detected", species_detected_default)
...
PreSelect_UMAP1 <- umap1_col
PreSelect_UMAP2 <- umap2_col
PreSelect_Annotation1 <- anno1_col
PreSelect_Annotation2 <- anno2_col

if (tolower(species_detected) == "human") {
  data(list = paste0("Geneset_list_HS"), package = "BERLIN")
  assign("geneset",get(paste0("Geneset_list_HS")))
  ...
  assign("GeneSet_CatTab",get(paste0("Geneset_Categories_MM")))
  GeneSet_Cats <- unique(GeneSet_CatTab[,1])
}
  ...
  navbarPage(paste0("{ ",Project_Name," UMAP }"),
             ...
             tabPanel("Heatmap",
                      sidebarLayout(
                        ...
                        mainPanel(
                          p(),
                          plotOutput("HeatmapAvg", height = "800px",width = "100%")
